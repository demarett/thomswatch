...
<header><a class="brand" routerLink="/"><span class="mark">TW</span><span>Thomswatch</span></a><nav><a routerLink="/" routerLinkActive="active" [routerLinkActiveOptions]="{exact:true}">Recherche</a>@if(player.profile();as profile){<a [routerLink]="['/profil',routeTag(profile.battleTag)]" routerLinkActive="active">Profil</a><a [routerLink]="['/historique',routeTag(profile.battleTag)]" routerLinkActive="active">Historique</a>}<a routerLink="/comparaison" routerLinkActive="active">Comparaison</a><a routerLink="/aide" routerLinkActive="active">Aide</a></nav></header>
